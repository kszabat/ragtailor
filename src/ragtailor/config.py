...
class Settings(BaseSettings):
    ...
    metadata_db_path: Path = Field(default=Path(__file__).resolve().parent.parent / "data" / "metadata.db")

    # default_dense_model: str = Field(default="BAAI/bge-m3")
    # default_sparse_model: str = Field(default=)
    # default_visual_model: str = Field(default=)
